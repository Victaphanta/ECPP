...
wget 'https://codeload.github.com/trinityrnaseq/trinityrnaseq/tar.gz/Trinity-v2.4.0'
pigz -dc Trinity-v2.4.0  | tar xf -
make -C trinityrnaseq-Trinity-v2.4.0/ 
mv trinityrnaseq-Trinity-v2.4.0 /usr/local/bin/trinity/
rm -rf trinityrnaseq-Trinity-v2.4.0

wget 'https://codeload.github.com/trinityrnaseq/trinityrnaseq/tar.gz/Trinity-v2.5.0'
pigz -dc Trinity-v2.5.0  | tar xf -
make -C trinityrnaseq-Trinity-v2.5.0/ 
rm -rf /usr/local/bin/trinity/
mv trinityrnaseq-Trinity-v2.5.0 /usr/local/bin/trinity/
rm -rf trinityrnaseq-Trinity-v2.5.0
...
wget 'https://nchc.dl.sourceforge.net/project/bowtie-bio/bowtie2/2.3.0/bowtie2-2.3.0-source.zip'
unzip  bowtie2-2.3.0-source.zip
make -C bowtie2-2.3.0/
mv bowtie2-2.3.0 /usr/local/bin/bowtie2/
rm -rf bowtie2-2.3.0

...
do
	...
	dedupe.sh in1=$ARG_R/$i\_R1.fastq.gz in2=$ARG_R/$i\_R2.fastq.gz out=$PWD/1_reads/DR/$i\.deduped.fastq.gz pigz=t unpigz=t overwrite=true 1>>$PWD/1_reads/dedup.log 2>&1
